...
const WorkSection = () => {
    ...
    return (
        <>
            <div className="px-2 py-8 sm:w-5/6 mx-auto flex flex-col items-center rounded-3xl rounded-br-[90px] justify-center bg-blue-tertiary md:p-8 space-y-6">
                <button className="font-semibold text-xs cursor-pointer px-2 py-2 rounded-lg shadow-sm bg-blue-primary bg-opacity-30 text-blue-opaque">
                ...
                <div className="w-full">
                    <div className="lg:flex  space-y-4 lg:space-y-0 lg:space-x-4">
                        <div
                            className={` flex lg:w-1/2 space-x-4 p-4 bg-blue-primary rounded-lg bg-opacity-25 hover:bg-opacity-40 transition-all duration-300 ${
                                toggleState === 1 ? "active-tab" : ""
                            }`}
                            onClick={() => toggleTab(1)}
                        >
