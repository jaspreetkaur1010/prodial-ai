    ...
    <div className="relative">
      ...
      >
        {videoInfo.map((video, index) => (
          <div
            key={index}
            className="group/container flex-none w-1/4 p-4 md:w-1/3 md:p-8 flex-col justify-center items-center bg-blue-opaque border border-blue-bg-light border-opacity-50 rounded-xl"
          >
            <div
            ...
            <div className="mx-auto pt-8 space-y-2">
              <h2 className="text-3xl font-semibold">
                <span className="bg-gradient-to-r from-blue-primary to-blue-secondary text-transparent bg-clip-text">
                  {video.head1}
                </span>{' '}
                {video.head2}
              </h2>
              <p>{video.description}</p>
              <button className="pt-6 text-blue-primary text-sm group-hover:underline group-hover:text-black">
                Learn more
