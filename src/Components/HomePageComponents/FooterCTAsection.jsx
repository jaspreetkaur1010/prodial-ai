...
function FooterCTAsection() {
    return (
        <div className='lg:flex lg:items-center py-6 space-y-8 lg:space-y-0 lg:space-x-8 py-12 px-6 sm:px-12 xl:px-24'>
            <div className='lg:w-1/2 lg:text-left'>
                <h2 className='lg:text-left text-3xl md:text-4xl lg:text-5xl font-semibold'>Ready to <br/> Supercharge Your <br/> Business with AI?</h2>
