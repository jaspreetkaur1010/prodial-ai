...
function FooterCTAsection() {
    return (
        <div className='lg:flex px-4 py-6 space-y-8 lg:space-y-0 lg:space-x-8 lg:px-24 lg:py-24'>
            <div className='lg:w-1/2 text-center lg:text-left'>
                <h2 className='text-4xl text-center lg:text-left xl:text-5xl font-semibold'>Ready to <br/> Supercharge Your <br/> Business with AI?</h2>
                <p className='pt-4 md:text-lg text-center lg:text-left'>Join thousands of businesses transforming their workflows with Prodigal AI.</p>
